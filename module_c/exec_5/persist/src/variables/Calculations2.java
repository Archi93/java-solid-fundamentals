...
public class Calculations2 {
    ...
    public static void main(String[] args) {
        ...
        String programRunning = "tak";
        while("tak".equals(programRunning)) {
        int height = Prompt.promptInt("Podaj wzrost w cm: ");
        double weightKg = Prompt.promptDouble("Podaj wagę w kg: ");
        int age = Prompt.promptInt("Podaj wiek:  ");
        String gender = Prompt.promptString("Jesteś[k]obietą czy [m]ężczyzną:  ");
        int MALE_FACTOR = 5;  
        int FEMALE_FACTOR= -161;
       
        double activitiFactor = Prompt.promptDouble("1.2 - przy pracy siedzącej i braku aktywności fizycznej; \n1.4 - przy pracy siedzącej i niskiej aktywności fizycznej (1-2 treningi w tygodniu) \n1.6 - przy pracy siedzącej i średniej aktywności fizycznej (3-4 treningi w tygodniu) \n1.8 - przy pracy fizycznej i średniej aktywnosci fizycznej (3-4 treningi w tygodniu) \n2.0 - przy bardzo wysokiej aktywności fizycznej (codzienne treningi, sportowcy) \nPodaj współczynnik aktywności fizycznej: ");
        ...
        programRunning = Prompt.promptString ("Czy wykonać kolejne wyliczenie [tak] / [nie] ? ");

...
public class Sentences {
    ...
    public static void main(String[] args) {
        ...
        boolean sleptWell = true;              // Jak spał dzisiaj Kleofiks?
        boolean ateBreakfast = false;            // Kleofiks zjadł śniadanie?
        boolean drankMorningCoffee = false;      // Kleofiks napił się porannej kawy?
